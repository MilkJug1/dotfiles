...
nm("<A-j>", ":m .+1<CR>==", "Move line down")
nm("<A-k>", ":m .-2<CR>==", "Move line up")
...
nm("<leader>ds", ":lua require('dap').continue() <cr>", "Debug: Start/Continue")
nm("<leader>di", ":lua require('dap').step_into() <cr>", "Debug: Step Into")
nm("<leader>do", ":lua require('dap').step_over() <cr>", "Debug: Step Over")
nm("<leader>de", ":lua require('dap').step_out() <cr>", "Debug: Step Out")
nm("<leader>dl", ':lua require("dapui").toggle()<cr>', "Debug: See Last Session Results")
nm(
	"<leader>bc",
	':lua require("dap").set_breakpoint(vim.fn.input("Breakpoint condition: ")) <cr>',
	"Conditional Breakpoint"
)
nm("<leader>ba", ":DapToggleBreakpoint<cr>", "Toggle Breakpoint")
