return {
    {
        ...
        opts = {
            ...
            -- NOTE: DO NOT FORMAT THIS, THE TEXT WILL GET WONKY AND ITS A PAIN TO FIX
 ...
 ╚██████╗ ╚██████╔╝ ██████╔╝ ███████╗
  ╚═════╝  ╚═════╝  ╚═════╝  ╚══════╝
        ...
        keys = {
            ...
            { "<leader>l",       function() Snacks.picker.lazy() end,                                    desc = "Search for Plugin Spec" },
            { "<leader>qs",      function() Snacks.picker.qflist() end,                                  desc = "Quickfix List" },
            { "<leader>su",      function() Snacks.picker.undo() end,                                    desc = "Undo History" }, -- NOTE: UndoTree would also be a good idea here too
